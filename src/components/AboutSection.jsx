    ...
    <section className="pt-40 mx-10 lg:mx-20 xl:mx-64 " id="about">
        ...
        <div className="grid grid-cols-12">
            <div className="col-span-12 md:col-span-6">
                <h2 className="text-colormind-text text-5xl font-extrabold mb-2">
                    {text.fullname}
                </h2>
                <h3 className='text-colormind-text text-3xl mb-6'><BiCode className='inline' /> {text.softwaredeveloper} <BiCodeAlt className='inline'/></h3>
                <p className='text-colormind-text text-md'>{text.description}</p>
                <Button color='success' className="mt-5 hover:scale-110 text-xl font-semibold" href={cvPdf} target='_blank' as={Link}> 
                    {text.downloadcv}
                </Button>
            </div>
            <div className='col-span-12 mt-10 md:mt-0 md:col-span-6 flex items-center justify-center'>
                <Button size='lg' href='#contact' as={Link} className="bg-colormind-button text-colormind-text font-semibold hover:scale-110 text-xl" aria-label="Contactame">
                    <BiSolidCommentDetail /> {text.contactme}
                </Button> 
            </div>
        </div>
    </section>
